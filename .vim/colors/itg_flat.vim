...
hi CursorLine	    guifg=#e4e4e4    ctermfg=254    guibg=#404040    ctermbg=237    gui=none    cterm=none
...
hi VertSplit	    guibg=#303030    ctermbg=236    guifg=#585858    ctermfg=240    gui=none    cterm=none
hi Visual	    	guifg=#f0e68c    ctermfg=255    guibg=#6b8e23    ctermbg=242    gui=none    cterm=none
hi MatchParen 		guibg=#303030   ctermbg=236    guifg=#00afff    ctermfg=39
